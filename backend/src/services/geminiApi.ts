...
提供された気象サマリー（年間日照時間、夏期の最高気温、冬期の最低気温）を分析し、以下を**具体的かつ専門的**に記述してください：
- **太陽光パネル設置の投資効率**：年間日照時間に基づく発電量の目安、自家消費・売電による光熱費削減効果、想定回収年数
- **推奨される住宅の断熱性能**：夏期の冷房負荷・冬期の暖房負荷に基づき、断熱等級（断熱等性能等級6相当など）、開口部仕様（Low-Eペアガラス／樹脂サッシなど）、推奨設備（高効率エアコン・全館空調・エコキュート等）を提示
- **省エネ・補助金との相性**：ZEH・長期優良住宅・子育てエコホーム等との適合可能性

## 11. 不動産プロの視点：物件の魅力とおすすめポイント` : `## 10. 不動産プロの視点：物件の魅力とおすすめポイント`}
...
${weather ? `## 10. 環境・省エネ適性 (Energy Efficiency & Climate Suitability)

Analyse the provided weather summary (annual sunshine hours, summer peak temperatures, winter low temperatures) and give concrete, professional advice on:
- **Solar PV investment efficiency**: estimated annual generation given the sunshine hours, electricity bill savings via self-consumption, and a realistic payback period
- **Recommended thermal insulation performance**: target insulation grade (e.g. Japan's 断熱等性能等級6 / HEAT20 G2), opening specs (Low-E pair glass, resin sash), and high-efficiency HVAC choices
- **Fit with energy programs**: ZEH, long-term-quality housing, and Kosodate Eco-Home Support eligibility

The heading must remain in Japanese (\`## 10. 環境・省エネ適性\`); the body should be in English.

## 11. Property Professional's Perspective` : `## 10. Property Professional's Perspective`}
