...
const BACKEND_LICENSES: LicenseEntry[] = [
  ...
  { name: "@google-cloud/bigquery", version: "7.x", license: "Apache-2.0", copyright: "Copyright (c) Google LLC", url: "https://github.com/googleapis/nodejs-bigquery" },
  { name: "@hono/node-server", version: "1.x", license: "MIT", copyright: "Copyright (c) 2022 - present, Yusuke Wada and Hono contributors", url: "https://github.com/honojs/node-server" },
  { name: "@lemonsqueezy/lemonsqueezy.js", version: "4.x", license: "MIT", copyright: "Copyright (c) 2024 Lemon Squeezy, LLC", url: "https://github.com/lmsqueezy/lemonsqueezy.js" },
  { name: "hono-rate-limiter", version: "0.5.x", license: "MIT", copyright: "Copyright (c) 2024 Rhinobase", url: "https://github.com/rhinobase/hono-rate-limiter" },
